...
namespace web{
    ...
    public:
        ...
        curl_error(CURLSHcode &errorcode, const std::string &file, int line, const std::string &func)noexcept :
            _error(ERR_FILE_LINE_FN(file,line,func)+curl_share_strerror(errorcode)){}
#else
        ...
        curl_error(CURLSHcode &errorcode)noexcept :_error(curl_share_strerror(errorcode)){}
#endif
