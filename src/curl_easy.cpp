...
void curl_easy::auto_manage(bool flag) noexcept { _auto_manage = flag; }

void curl_easy::add_easy_extant(unsigned int num) noexcept { _easy_extant += num; }
void curl_easy::sub_easy_extant(unsigned int num) noexcept { _easy_extant -= num; }

size_t curl_easy::getExtant() noexcept { return _easy_extant; }
...
curl_easy::operator bool() const noexcept { return _curl == nullptr; }
curl_easy::operator CURL*() const noexcept { return _curl; }
...
CURL* curl_easy::getHandle() const noexcept { return _curl; }
CURLcode curl_easy::getError() const noexcept { return _error; }
const char* curl_easy::getErrorText() const noexcept { return curl_easy_strerror(_error); }
const std::vector<CURLcode>& curl_easy::getErrorVec() const noexcept { return _error_vec; }
}
